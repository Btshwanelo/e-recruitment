...
const initialState: JobsState = {
 jobs: [
  // Learnerships
  {
    ...
    description: 'A comprehensive 12-month IT learnership program designed to equip learners with essential IT skills within the correctional services environment.',
    requirements: [
  ...
  },
  {
    ...
    description: 'An 18-month learnership program focused on correctional services operations, rehabilitation programs, and offender management.',
    requirements: [
