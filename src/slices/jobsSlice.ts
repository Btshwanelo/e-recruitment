...
const initialState: JobsState = {
  jobs: [
    // Learnerships
    {
      ...
      reference: 'ITL2025001',
      postNumber: 'POST-ITL-001',
      applicationRef: 'REF-ITL-2025-001',
      isFavorite: false,
    },
    {
      id: 'csl2024001',
      ...
      reference: 'CSL2025001',
      postNumber: 'POST-CSL-001',
      applicationRef: 'REF-CSL-2025-001',
      isFavorite: false,
    },
    {
      id: 'afl2024001',
      ...
      reference: 'AFL2025001',
      postNumber: 'POST-AFL-001',
      applicationRef: 'REF-AFL-2025-001',
      isFavorite: false,
    },
    ...
    // Permanent Positions
    {
      ...
      reference: 'CO2025001',
      postNumber: 'POST-CO-001',
      applicationRef: 'REF-CO-2025-001',
      isFavorite: false,
    },
    {
      id: 'sw2024001',
      ...
      reference: 'SW2025001',
      postNumber: 'POST-SW-001',
      applicationRef: 'REF-SW-2025-001',
      isFavorite: false,
    },
    {
      id: 'aorm001',
      ...
      reference: 'AORM2025001',
      postNumber: 'POST-AORM-001',
      applicationRef: 'REF-AORM-2025-001',
      isFavorite: false,
    },
    {
      id: 'hr2024001',
      ...
      reference: 'HR2025001',
      postNumber: 'POST-HR-001',
      applicationRef: 'REF-HR-2025-001',
      isFavorite: false,
    },
    {
      id: 'psych2024001',
      ...
      reference: 'PSYCH2025001',
      postNumber: 'POST-PSYCH-001',
      applicationRef: 'REF-PSYCH-2025-001',
      isFavorite: false,
    },
    ...
    // Contract Positions
    {
      ...
      reference: 'SEC2025001',
      postNumber: 'POST-SEC-001',
      applicationRef: 'REF-SEC-2025-001',
      isFavorite: false,
    },
    {
      id: 'nurse2024001',
      ...
      reference: 'NURSE2025001',
      postNumber: 'POST-NURSE-001',
      applicationRef: 'REF-NURSE-2025-001',
      isFavorite: false,
    },
    {
      id: 'teacher2024001',
      ...
      reference: 'TEACHER2025001',
      postNumber: 'POST-TEACHER-001',
      applicationRef: 'REF-TEACHER-2025-001',
      isFavorite: false,
    },
    {
      id: 'maint2024001',
      ...
      reference: 'MAINT2025001',
      postNumber: 'POST-MAINT-001',
      applicationRef: 'REF-MAINT-2025-001',
      isFavorite: false,
    },
  ],
  applications: [
    {
      id: 'app_001',
      jobId: 'itl2024001',
      jobTitle: 'Information Technology Learnership',
