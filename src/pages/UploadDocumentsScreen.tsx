        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="space-y-6 max-w-xl">
            ...
            <div>
              ...
              <div className="flex">
                <Input type="text" readOnly value={files.payslip.name} className="rounded-r-none border border-gray-300 bg-white" />
                <Button
                  variant="outline"
            ...
            <div>
              ...
              <div className="flex">
                <Input type="text" readOnly value={files.idDocument.name} className="rounded-r-none border border-gray-300 bg-white" />
                <Button
                  variant="outline"
                  className="rounded-l-none border-l-0 px-3 border border-gray-300"
            ...
            <div className="max-w-2xl flex gap-4 items-start justify-self-start">
              <Button variant="outline" onClick={handlePreviousClick} className="border border-gray-300">
                Previous
              </Button>

              <Button onClick={handleNextClick} className="bg-sky-500 hover:bg-sky-600 text-white">
                Next
              </Button>
            </div>
          </div>
