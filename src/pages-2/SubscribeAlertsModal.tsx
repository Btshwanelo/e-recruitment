...
const SubscribeAlertsModal: React.FC<SubscribeAlertsModalProps> = ({
  isOpen,
  onClose,
  onSave,
}) => {
      ...
      <DialogContent className="sm:max-w-md bg-white">
        <DialogHeader>
          ...
          <p className="text-gray-500 text-sm mt-2">
            Get notified about new job opportunities that match your interests.
          </p>
        </DialogHeader>
        ...
        <DialogFooter className="sm:justify-between border-t border-gray-200 pt-4">
          ...
          <Button
            onClick={handleSave}
            className="bg-[#0086C9] hover:bg-[#0077b3] text-white"
          >
            Save
          </Button>
        </DialogFooter>
